      ...
      sidebar: [
          ...
          items: [
            ...
            { label: 'HTTPS & Domain Lock', slug: 'guides/domain-lock' },
            {
              ...
              items: [
                ...
                { label: 'IMAP / Other email', slug: 'guides/connect-email-imap' },
              ],
            },
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'Verifying the Audit Trail', slug: 'concepts/audit-trail-verification' },
            { label: 'AI Disclosure', slug: 'concepts/ai-disclosure' },
